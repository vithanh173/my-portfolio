...
function MyPortfolio() {
    ...
    return (
        <section id="Projects" className={clsx(styles.project_section)}>
            <div className={clsx(styles.section_title)}>
                <h1>Projects</h1>
                <a href="https://github.com/vithanh173">
                    <button className={clsx(styles.btn, styles.btn_github)}>
            ...
            <div className={clsx(styles.project_container)}>
